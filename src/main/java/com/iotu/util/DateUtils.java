...
/**
 * function： 日期工具集合，用于格式化日期 version： 1.0
 */
public class DateUtils {
	...
	public static String getDateFormat(Date date, String formatStr) {
		...
		if (StringUtils.empty(formatStr)) {
	...
	public static String getHourMinuteSecond(Date date, String str) {
		...
		SimpleDateFormat decimal = new SimpleDateFormat("HH" + str + "mm" + str
				+ "ss");
		dateFormat = decimal.format(date);
		return dateFormat;
	}
	...
	public static String getDate(Date date){
		...
		SimpleDateFormat decimal = new SimpleDateFormat("yyyyMMdd");
		dateFormat = decimal.format(date);
		return dateFormat;
	}
	...
	/**
	 * 判断两日期大小 bigDate大于smallDate返回true，否则返回false
	 * 
	 * @param bigDate
	 * @param smallDate
	 * @return
	...
	/**
	 * 判断两日期是否相等 bigDate等于smallDate返回true，否则返回false
	 * 
	 * @param bigDate
	 * @param smallDate
	 * @return
	...
	public static Date getDate() {
		...
		try {
			SimpleDateFormat format = new SimpleDateFormat(
					"yyyy-MM-dd HH:mm:ss");
			date = format.parse(getDateFormat());
